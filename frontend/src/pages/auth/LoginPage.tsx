...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#fff9f3] via-[#ffece1] to-[#f5d4c8] px-5 py-10 text-[#2b2220]">
      <div className="mx-auto grid w-[min(1120px,96vw)] gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <section className="hidden lg:block">
          <p className="text-xs uppercase tracking-[0.14em] text-[#6f332f]">Private Anniversary API</p>
        ...
        <AuthCard title="Login" subtitle="Gunakan akun API dasar (user/login) untuk masuk.">
