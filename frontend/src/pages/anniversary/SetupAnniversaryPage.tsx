  ...
  return (
    <section className="space-y-4">
      <article className="rounded-2xl border border-[#9c4f46]/20 bg-white/65 p-5">
        <p className="text-xs uppercase tracking-[0.12em] text-[#6f332f]">Setup API</p>
        <h1 className="mt-2 font-display text-4xl leading-none">Setup Anniversary JSON</h1>
        <p className="mt-2 text-sm text-[#2b2220]/70">
          Endpoint: <code>GET/PUT /api/setup/anniversary</code>, <code>PUT/POST/DELETE /api/setup/anniversary/moments</code>
        </p>
      </article>
